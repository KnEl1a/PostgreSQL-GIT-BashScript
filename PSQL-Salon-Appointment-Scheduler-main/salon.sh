...
# show available services
  ...
  if [[ -z $SERVICES ]]
  then
    echo "Sorry, don't have any service right now"
  ...
  # if the choice is not a number
    ...
    then
    # send to main menu
      MAIN_MENU "Sorry, is not a valid number! Please, choose again."
    else
      ...
      then
      # send to main menu
        MAIN_MENU "I could'nt find that service. What woul  you like?"
      else
      # get customer phone number
        ...
        # if is a new customer
          ...
          echo -e "\nI do not have a record for that phone number, what is your name?"
          read CUSTOMER_NAME
